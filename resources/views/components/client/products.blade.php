...
<div id="quickViewModal" class="fixed inset-0 z-50 hidden items-center justify-center p-4">
    ...
    <div class="relative bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div class="p-6">
            ...
            <div id="result_Product" class="grid md:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    ...
                    <!-- Stock Status -->
                    <div class="flex items-center gap-2">
                        <span class="inline-block w-12 h-5 bg-green-700 rounded-full text-white text-center Stok1">Stok</span>
                        <span class="text-sm text-green-600 font-medium Stock"> </span>
                    </div>
        ...
        <button type="submit" id="addToCartBtn"
            class="flex-1 w-full bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700 transition-colors font-medium flex items-center justify-center gap-2">
                    ...
                    <form id="reviewForm" class="space-y-4">
                        ...
                        <div class="relative flex items-center">
                            <input type="text" name="comment" id="review_input" placeholder="Write your review..."
                                class="w-full pl-4 pr-12 py-3 bg-gray-50 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-green-700 transition"
                                required />

                            <button type="submit" class="absolute right-3 text-gray-400 hover:text-green-600 focus:outline-none">

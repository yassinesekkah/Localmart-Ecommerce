            ...
            <div id="result_Product" class="grid md:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    <div class="bg-gray-100 rounded-lg overflow-hidden">
                        <img id="productMainImage" src="/assets/images/products/product-img-1.jpg" alt="Product" class="w-full h-96 object-cover" />
                    </div>
                    <div class="grid grid-cols-4 gap-2" id="productThumbnails">
                        <img src="/assets/images/products/product-img-1.jpg" alt="Thumbnail" class="w-full h-20 object-cover rounded cursor-pointer border-2 border-green-600" />
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button class="bg-gray-100 text-gray-800 px-4 py-3 rounded-lg hover:bg-gray-200 transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">

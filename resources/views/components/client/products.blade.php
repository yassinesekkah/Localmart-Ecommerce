        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            ...
            <div onclick="openQuickViewModal({{ $product->id }})" class="group bg-white border cursor-pointer border-gray-200 rounded-xl p-4 hover:shadow-lg transition-all duration-300">
                ...
                <div class="relative mb-4 overflow-hidden rounded-lg">
                    ...
                    <span class="absolute top-2 left-2 z-10 bg-red-600 text-white text-xs font-semibold px-2.5 py-1 rounded-md">
                        Sale
                    </span>
                    @endif
                    ...
                    <!-- Hover Actions -->
                    <div class="absolute inset-x-0 bottom-4 flex justify-center items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <!-- Quick View Button -->
                        ...
                        <!-- Wishlist Button -->
                        <button class="p-2 bg-white rounded-lg shadow-md hover:bg-green-600 hover:text-white transition-colors duration-200"

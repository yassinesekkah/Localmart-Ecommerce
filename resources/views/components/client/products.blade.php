            ...
            <div id="result_Product" class="grid md:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    <div class="bg-gray-100 rounded-lg overflow-hidden">
                        <img id="productMainImage" src="https://via.placeholder.com/400x400/e5e7eb/1f2937?text=Loading..." alt="Product" class="w-full h-96 object-cover" />
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <form id="orderForm" class="border-t pt-4 space-y-4">
                        ...
                        <div class="flex items-center gap-4">
                            <div class="flex items-center">
                                ...
                                <div class="border border-gray-300 rounded-lg flex items-center">
                                    <button type="button" onclick="decrementQuantity(this)" class="w-10 h-10 text-gray-600 hover:text-gray-800 hover:bg-gray-100 transition-colors">-</button>
                                    <input type="number" name="quantity" id="orderQuantity" value="1" min="1" max="10" class="w-16 text-center border-0 focus:ring-0" readonly />
                                    <button type="button" onclick="incrementQuantity(this)" class="w-10 h-10 text-gray-600 hover:text-gray-800 hover:bg-gray-100 transition-colors">+</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-3">
                            <button type="submit" id="addToCartBtn" class="flex-1 bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700 transition-colors font-medium flex items-center justify-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                                </svg>
                                <span>Add to Cart</span>
                            </button>
                            <button type="button" class="bg-gray-100 text-gray-800 px-4 py-3 rounded-lg hover:bg-gray-200 transition-colors">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div class="mb-8">
                    <form id="reviewForm" class="space-y-4">
                        ...
                        <label class="flex items-center justify-start">
                            <div class="w-10 h-10 bg-green-400 text-white rounded-full flex items-center justify-center mr-4 font-semibold">
...
function displayReviews(reviews) {
    ...
    reviewsList.innerHTML = reviews.map(comment => {
        const initials = comment.user?.name ? comment.user.name.split(' ').map(n => n[0]).join('').toUpperCase().substring(0, 2) : 'UN';

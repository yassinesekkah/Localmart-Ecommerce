        ...
        <div class="p-6">
                ...
                <div class="space-y-4">
                    <div class="bg-gray-100 rounded-lg overflow-hidden"> hjbjkbbjkbkbkbk
                        <img id="productMainImage"
                            src="{{ $product->image ? asset('storage/' . $product->image) : url('https://commons.wikimedia.org/wiki/File:ZenFone_6_Mockup.svg') }}"
                            alt="Product image" class="w-full h-96 object-cover" />
                    </div>
            ...
            <div id="reviews" class="tab-content">
                ...
                <div class="mb-8">
                    ...
                    <textarea name="review" id="review" rows="4" placeholder="Write your review..."
                        class="
                            w-full 
                            px-4 py-3
                            bg-gray-50
                        ...
                        "></textarea>
                    <button
                        class="px-4 py-2 mt-1 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition">
                        Ajouter Review
                    </button>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        <div class="flex items-start justify-between mb-3">
                            <div class="flex items-center">
                                <div
                                    class="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center text-green-600 font-semibold mr-4">
                                    JD
                                </div>
                                <div>
                        ...
                        <p class="text-gray-600 mb-4">
                            This is one of the best snacks I've ever had. The taste is authentic and the quality is
                            top-notch.
                            Highly recommended for everyone who loves traditional Indian snacks. The packaging was also
                            very good.
                        </p>
